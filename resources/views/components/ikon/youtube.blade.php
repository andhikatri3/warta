{{-- Lambang YouTube: persegi membulat dengan segitiga yang dilubangi
     (evenodd), bukan segitiga putih di atasnya — jadi tetap satu warna
     aksen seperti ikon lainnya. --}}
<svg {{ $attributes }} viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd" aria-hidden="true">
